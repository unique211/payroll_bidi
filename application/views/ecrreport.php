                        ...
                        <div class="panel-heading">
                           <div class="panel-title"></div>
                          	  <div class="panel-body">
                                 ...
                                 <input type="text" class="form-control month_year" id="month_year" name="month_year" value='' placeholder="Select Date*" required>
                                 ...
                                 <select type="text" class="form-control" id="pmrpy" name="pmrpy" value=''>
...
<div id="wait" style="display:none;width:100px;height:100px;position:absolute;top:;left:45%;padding:2px;"><img src="<?php echo base_url('assets/images/loader.gif'); ?>" width="100" height="100" /><br><center><h5>Loading...</h5></center></div>
 ...
 <script type="text/javascript">var baseurl = "<?php print base_url(); ?>";</script>
   ...
   <?php include('footer.php');?>
      ...
      <script src="<?php echo base_url().'assets/js/js/ecr_report_js.js';?>"></script>   
<script>
