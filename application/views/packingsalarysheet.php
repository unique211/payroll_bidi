                        ...
                        <div class="panel-heading">
                           <div class="panel-title"></div>
                          	  <div class="panel-body">
                                 ...
                                 <input type="text" class="form-control month_year" id="month_year" name="month_year" value='' placeholder="Select Date">
                                 <label id="d" style="color:red;"></label>
										      ...
										      <div class="col-md-1">
                                    <center> 
                                        <a id="search_month" class="btn btn-primary button_change">Search</a>													
...
<div id="wait" style="display:none;width:100px;height:100px;position:absolute;top:;left:45%;padding:2px;"><img src="<?php echo base_url('assets/images/loader.gif'); ?>" width="100" height="100" /><br><center><h5>Loading...</h5></center></div>
 ...
 <script type="text/javascript">var baseurl = "<?php print base_url(); ?>";</script>
   ...
   <?php include('footer.php');?>
      ...
      <script src="<?php echo base_url().'assets/js/js/packer_salary_sheet_js.js';?>"></script>   
...
<script>
   ...
   $(document).ready(function() {
	   ...
	   var msg = "<center><h1>PACKERS  SALARY  SHEET</h1><br><p style='font-size:15;'>Name And Address of principal Employer : BRIJBASHI TRADERS, BANDHA GHAT, JHALDA, PURULIA<br>Nature and Location of work : JHALDA</p></center>";
    $('#example1').dataTable({
