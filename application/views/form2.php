...
<!--						<button type="button" class="btn btn-primary" id="new"><em class="fa fa-plus"></em> Office Staff</button>		
	-->					
            ...
            <div class="row">
               <div class="col-md-12">
		<form action="<?php echo base_url('Exportpdf/form2');?>" method="post" target="_blank">
                     <!-- START panel-->
						<div id="hide_show1">
...
-->
                		<button id="export_form" type="submit" href="" class="btn btn-primary " >Download Form 2</button>
